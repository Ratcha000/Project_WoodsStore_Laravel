...
<div class="container mt-4">
    ...
    <form action="{{ route('costs.update', $cost->Cost_ID) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="mb-3">
            <label for="Total_Cost">ยอดรวม</label>
            <input type="number" name="Total_Cost" class="form-control" step="0.01" value="{{ $cost->Total_Cost }}" required>
        </div>

        <button type="submit" class="btn btn-primary">อัปเดตค่าใช้จ่าย</button>
    </form>
</div>
</body>
</html>
